 ...
 */
@Transactional
public class ReportingObjectGroupSerializedDefinitionServiceImpl extends BaseOpenmrsService implements ReportingObjectGroupSerializedDefinitionService {
	
	protected static Log log = LogFactory.getLog(ReportingObjectGroupSerializedDefinitionServiceImpl.class);
